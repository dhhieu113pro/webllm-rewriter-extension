...
export const DEFAULT_ADO_SUMMARY_PROMPT = `Summarize the following Azure DevOps Work Item in exactly 2 sections:

### Summary
(1-2 sentences: what this ticket is about)

### Solution
(1-2 sentences: what is being done or proposed)
